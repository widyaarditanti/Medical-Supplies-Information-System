...
if($drop1==1 && $drop2==0 && $drop100==0){//drop1 nyala yang 2 kd
        ...
        $sql= "SELECT kategori_transaksi.nama as katas,admin.username as namad,pusat_kesehatan.nama as namas,transaksi.trans_id,transaksi.tanggal,transaksi.status,transaksi.admin_id,transaksi.pk_provider,p1.nama as namax,transaksi.pk_penyumbang,kategori_transaksi.nama FROM transaksi 
        ...
        where  transaksi.admin_id=$adminss
        ORDER BY transaksi.trans_id ASC
        LIMIT $awalData, $jumlahDataPerHalaman" ;
    
    $sql2="SELECT kategori_transaksi.nama as katas,admin.username as namad,pusat_kesehatan.nama as namas,transaksi.trans_id,transaksi.tanggal,transaksi.status,transaksi.admin_id,transaksi.pk_provider,p1.nama as namax,transaksi.pk_penyumbang,kategori_transaksi.nama FROM transaksi 
    JOIN kategori_transaksi 
    ON transaksi.kategori_transaksi=kategori_transaksi.id 
    join admin 
    ON admin.admin_id=transaksi.admin_id 
  ...
  ORDER BY transaksi.trans_id ASC " ;
    ...
    ON admin.admin_id=transaksi.admin_id 
        ...
        on p1.pk_id=transaksi.pk_penyumbang
    join pusat_kesehatan
    ON pusat_kesehatan.pk_id=transaksi.pk_provider where transaksi.admin_id=$adminss
    ORDER BY transaksi.trans_id ASC 
    LIMIT $awalData, $jumlahDataPerHalaman";
...
//whisker
    ...
    if($search!=" "){
        ...
        on p1.pk_id=transaksi.pk_penyumbang
            ...
            and  transaksi.admin_id=$adminss
            ORDER BY transaksi.trans_id ASC
            LIMIT $awalData, $jumlahDataPerHalaman";
            $sql2= "SELECT kategori_transaksi.nama as katas,admin.username as namad,pusat_kesehatan.nama as namas,transaksi.trans_id,transaksi.tanggal,transaksi.status,transaksi.admin_id,transaksi.pk_provider,p1.nama as namax,transaksi.pk_penyumbang,kategori_transaksi.nama FROM transaksi 
            JOIN kategori_transaksi 
