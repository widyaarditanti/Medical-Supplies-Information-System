...
<head>
	...
	var dropmut2=0;
    	...
    	$(document).ready(function(){
			 ...
			 searchtext=" ";
					$.ajax({
						url: "includes/get_data_transaction_central.php",
			            type: "POST",
			            dataType: "json",
					...
					$.ajax({
						url: "includes/get_data_transaksi_central_card.php",
			            type: "POST",
			            dataType: "json",
						...
						for(var i=0;i<data.length;i++){
								...
								Gstring+= "(<span class='From_Admin'>"+"<?php echo $_SESSION['username']; ?>"+"</span>)";
								Gstring+="&nbsp;&nbsp;";
